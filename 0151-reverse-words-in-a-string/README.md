...
<p>Return <em>a string of the words in reverse order concatenated by a single space.<inliner class="im-inliner-dst-text" style="color: #239E23;"> [단일 공백으로 연결된 단어의 문자열을 역순으로 반환합니다.] </inliner></em></p>
